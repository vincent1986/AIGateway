...
const dict = {
  zh: {
    ...
    "preset.qwen": "通义千问",
    "preset.zhipu": "智谱",
    "preset.siliconflow": "硅基流动",
    "preset.doubao": "豆包/火山",
    "preset.yi": "零一万物",
    "preset.custom": "自定义",
    "preset.blurb.local": "本机服务，无需云端 Key",
    "preset.blurb.deepseek": "官方 API，性价比高",
    "preset.blurb.silicon": "聚合多模型，价格透明",
    "preset.blurb.custom": "手动填写任意 OpenAI 兼容地址",
    "modal.presetPick": "点选厂家预设",
    "modal.presetHint": "云厂家只需粘贴 API Key，Base URL 已内置",
    "modal.keyOnly": "API Key",
    "modal.keyOnlyPh": "粘贴 API Key 即可添加",
    "modal.advanced": "高级选项（名称 / Base URL / 代理 / 格式）",
    "modal.region.local": "本机",
    "modal.region.cn": "国内",
    "modal.region.global": "国际",
    "modal.region.custom": "自定义",
    "toast.needKeyCloud": "请填写 API Key",
    "toast.presetExists": "已存在同 ID 厂家，请直接编辑或换名称",
    ...
    "configs.title": "应用管理",
    "configs.desc": "卡片式工具接入（{platform}）：一键接管 AIGateway 统一入口，模型由「模型管理」调度。",
    "apps.takeover": "一键接管",
    "apps.rollback": "卸载/还原",
    "apps.takeoverHint": "写入 base_url 指向本地网关，终端无需再改配置",
    "apps.takenOver": "已接管",
    "models.title": "模型管理",
    "models.desc": "虚拟模型组：多厂家横向聚合、优先级队列与额度状态。网关按此顺序 Failover。",
    "models.refresh": "刷新",
    "models.colGroup": "模型组",
    "models.colProvider": "供应厂家",
    "models.colStatus": "状态",
    "models.colPriority": "优先级",
    "models.colUsed": "已用 Token",
    "models.colActions": "操作",
    "models.empty": "暂无模型组。请在「厂家管理」拉取并启用模型后自动聚合。",
    "models.priorityUp": "提高优先",
    "models.priorityDown": "降低优先",
    "models.enable": "启用通道",
    "models.disable": "停用通道",
    "models.statusOk": "正常",
    "models.statusStandby": "备用",
    "models.statusDisabled": "已停用",
    "models.statusExhausted": "额度耗尽",
    "models.statusCircuit": "熔断",
    "models.dragHint": "同组内拖拽通道可调整 Failover 优先级（越靠上越优先）。",
    "models.drag": "拖拽排序",
    "models.channels": "条通道",
    "models.reordered": "优先级已更新",
    ...
    "detail.formatStandard": "数据格式标准",
    "detail.formatOpenAI": "标准 OpenAI 格式",
    "detail.formatPassthrough": "原样转发 (Passthrough)",
    "detail.formatHint": "OpenAI：网关规整报文；Passthrough：上下行 body 原样透传",
    "detail.save": "保存配置",
    "detail.testing": "测试中…",
    "detail.test": "测试连接",
    "detail.fetching": "获取中…",
    ...
    "detail.modelsDesc": "仅管理本厂家模型启停；多渠道调度请到「模型管理」",
  ...
  en: {
    ...
    "preset.doubao": "Doubao / Volcengine",
    "preset.yi": "01.AI",
    "preset.custom": "Custom",
    "preset.blurb.local": "Local service — no cloud key",
    "preset.blurb.deepseek": "Official API, cost-efficient",
    "preset.blurb.silicon": "Multi-model marketplace",
    "preset.blurb.custom": "Any OpenAI-compatible base URL",
    "modal.presetPick": "Pick a preset",
    "modal.presetHint": "Cloud vendors: paste API Key only — Base URL is built-in",
    "modal.keyOnly": "API Key",
    "modal.keyOnlyPh": "Paste API Key to add",
    "modal.advanced": "Advanced (name / Base URL / proxy / format)",
    "modal.region.local": "Local",
    "modal.region.cn": "China",
    "modal.region.global": "Global",
    "modal.region.custom": "Custom",
    "toast.needKeyCloud": "API Key is required",
    "toast.presetExists": "A provider with this ID already exists",
    ...
    "configs.title": "Apps",
    "configs.desc": "Tool cards on {platform}: one-click takeover of AIGateway; routing lives under Models.",
    "apps.takeover": "Take over",
    "apps.rollback": "Uninstall / restore",
    "apps.takeoverHint": "Write base_url to local gateway — no more config edits in the terminal",
    "apps.takenOver": "Managed",
    "models.title": "Models",
    "models.desc": "Virtual model groups: multi-provider aggregation, priority queue, and status. Gateway failovers in this order.",
    "models.refresh": "Refresh",
    "models.colGroup": "Group",
    "models.colProvider": "Provider",
    "models.colStatus": "Status",
    "models.colPriority": "Priority",
    "models.colUsed": "Used tokens",
    "models.colActions": "Actions",
    "models.empty": "No model groups yet. Fetch and enable models under Providers.",
    "models.priorityUp": "Higher priority",
    "models.priorityDown": "Lower priority",
    "models.enable": "Enable route",
    "models.disable": "Disable route",
    "models.statusOk": "OK",
    "models.statusStandby": "Standby",
    "models.statusDisabled": "Disabled",
    "models.statusExhausted": "Exhausted",
    "models.statusCircuit": "Circuit open",
    "models.dragHint": "Drag channels within a group to set failover priority (top = preferred).",
    "models.drag": "Drag to reorder",
    "models.channels": "channel(s)",
    "models.reordered": "Priority updated",
    ...
    "detail.formatStandard": "Payload format",
    "detail.formatOpenAI": "Standard OpenAI",
    "detail.formatPassthrough": "Passthrough",
    "detail.formatHint": "OpenAI: normalize payloads in the gateway; Passthrough: forward body as-is",
    "detail.save": "Save",
    ...
    "detail.modelsDesc": "Enable/disable only; multi-provider routing is under Models",
